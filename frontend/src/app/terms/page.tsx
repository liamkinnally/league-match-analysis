...
export default function TermsPage() {
  return <PolicyPage title="Terms of Service">
    <p>{PRODUCT_NAME} is a free prototype intended for development, testing, and review—not intended for general public use. It is not an official Riot Games service.</p>

    <h2>Using the prototype</h2>
    <p>You may use the site to inspect the included sample and supported League of Legends match records. Live lookup currently supports NA1 players, ranked Solo/Duo and the latest five matches. No Riot account sign-in is required.</p>
    <p>The prototype is accessible by direct link and uses search-engine directives to request that its pages not be indexed.</p>
    ...
    <p>The prototype may be changed, interrupted or withdrawn. Live lookup depends on Riot API availability and rate limits. It may be temporarily unavailable during testing or deployment.</p>
